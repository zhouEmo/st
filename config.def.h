...
static Shortcut shortcuts[] = {
	...
	{ MODKEY|ShiftMask,     XK_K,           kscrollup,      {.i = -1} }, /* 向上跳一页 */
	{ MODKEY|ShiftMask,     XK_J,           kscrolldown,    {.i = -1} }, /* 向下跳一页 */
	{ MODKEY|ControlMask,   XK_k,           kscrollup,      {.i =  1} }, /* 向上移动一行 */
	{ MODKEY|ControlMask,   XK_j,           kscrolldown,    {.i =  1} }, /* 向下移动一行 */
	{ MODKEY|ShiftMask,     XK_I,           zoom,           {.f = +1} }, /* 放大 */
	{ MODKEY|ShiftMask,     XK_N,           zoom,           {.f = -1} }, /* 缩小 */
